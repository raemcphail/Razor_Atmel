...
#ifdef MPG2 
static LedNumber Type aeCurrentLed[] = {GREEN0, RED0, BLUE0, GREEN0,RED0, BLUE0};
static LedNumber Type aeCurrentLed[] = {GREEN1, RED1, BLUE1, GREEN1,RED1, BLUE1};
static LedNumber Type aeCurrentLed[] = {GREEN2, RED2, BLUE2, GREEN2,RED2, BLUE2};
static LedNumber Type aeCurrentLed[] = {GREEN3, RED3, BLUE3, GREEN3,RED3, BLUE3};
#endif /* MPG2*/
...
void UserApp1RunActiveState(void)
{
 ...
 /* Advance the cycle only if bCyclingOn*/
  ...
  /*Update the current level bsed on which way it's headed*/
